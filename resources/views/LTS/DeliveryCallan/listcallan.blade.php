                   ...
                   <div class="container py-5">
                      <div class="row">
                         <div class="col-md-12">
                           ...
                           <div class="card-body">
                              <form action="{{route('getdatareportsearch')}}" method="POST">
                                 @csrf
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                      <div class="dropdown">
                                                         ...
                                                         <li>  <button type="button"   data-url="{{ url('/listcallan/show', $addcallan->id) }}" id="show-user"   class="btn btn-danger  showbtn btn-sm">View</button>&nbsp;<br></li>                                                            
                                                         </ul>
                                                      </div>
                                                </td>
                                            </tr>
